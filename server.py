...
def subscribe_newsletter(data: Newsletter):
    ...
    try:
        ...
        conn.close(); return {'message': "You're already subscribed! Thanks for your enthusiasm."}
